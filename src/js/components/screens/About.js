...
const About = () => {
    ...
    return (
        <div className='about gui'>
            ...
            <p className={'about__text about__text--paragraph'}>SmartSweeper is a classic minesweeper with a twist. Player can choose one of four types of gameplay and one of four types of mine detection.</p>
            <p className={'about__text about__text--paragraph'}>The entire interface is designed only with React components and CSS styling, without any audio and static graphic files. The Hexplorist portrait is based on DiceBear avatar library API.</p>
